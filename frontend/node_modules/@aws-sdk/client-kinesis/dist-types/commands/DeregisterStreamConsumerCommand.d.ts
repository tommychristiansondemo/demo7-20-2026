...
declare const DeregisterStreamConsumerCommand_base: {
    new (input: DeregisterStreamConsumerCommandInput): import("@smithy/core/client").CommandImpl<DeregisterStreamConsumerCommandInput, DeregisterStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeregisterStreamConsumerCommandInput]): import("@smithy/core/client").CommandImpl<DeregisterStreamConsumerCommandInput, DeregisterStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
