...
declare const RemoveTagsFromStreamCommand_base: {
    new (input: RemoveTagsFromStreamCommandInput): import("@smithy/core/client").CommandImpl<RemoveTagsFromStreamCommandInput, RemoveTagsFromStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RemoveTagsFromStreamCommandInput): import("@smithy/core/client").CommandImpl<RemoveTagsFromStreamCommandInput, RemoveTagsFromStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
