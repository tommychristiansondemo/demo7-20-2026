...
declare const StartStreamEncryptionCommand_base: {
    new (input: StartStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StartStreamEncryptionCommandInput, StartStreamEncryptionCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StartStreamEncryptionCommandInput, StartStreamEncryptionCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
