...
declare const DescribeStreamConsumerCommand_base: {
    new (input: DescribeStreamConsumerCommandInput): import("@smithy/core/client").CommandImpl<DescribeStreamConsumerCommandInput, DescribeStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStreamConsumerCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStreamConsumerCommandInput, DescribeStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
