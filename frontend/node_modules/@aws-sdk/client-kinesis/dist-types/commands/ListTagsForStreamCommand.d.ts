...
declare const ListTagsForStreamCommand_base: {
    new (input: ListTagsForStreamCommandInput): import("@smithy/core/client").CommandImpl<ListTagsForStreamCommandInput, ListTagsForStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTagsForStreamCommandInput]): import("@smithy/core/client").CommandImpl<ListTagsForStreamCommandInput, ListTagsForStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
