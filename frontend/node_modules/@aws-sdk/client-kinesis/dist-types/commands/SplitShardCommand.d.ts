...
declare const SplitShardCommand_base: {
    new (input: SplitShardCommandInput): import("@smithy/core/client").CommandImpl<SplitShardCommandInput, SplitShardCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SplitShardCommandInput): import("@smithy/core/client").CommandImpl<SplitShardCommandInput, SplitShardCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
