...
declare const ListStreamConsumersCommand_base: {
    new (input: ListStreamConsumersCommandInput): import("@smithy/core/client").CommandImpl<ListStreamConsumersCommandInput, ListStreamConsumersCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStreamConsumersCommandInput): import("@smithy/core/client").CommandImpl<ListStreamConsumersCommandInput, ListStreamConsumersCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
