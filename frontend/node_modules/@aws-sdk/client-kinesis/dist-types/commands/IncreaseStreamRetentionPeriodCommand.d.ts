...
declare const IncreaseStreamRetentionPeriodCommand_base: {
    new (input: IncreaseStreamRetentionPeriodCommandInput): import("@smithy/core/client").CommandImpl<IncreaseStreamRetentionPeriodCommandInput, IncreaseStreamRetentionPeriodCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: IncreaseStreamRetentionPeriodCommandInput): import("@smithy/core/client").CommandImpl<IncreaseStreamRetentionPeriodCommandInput, IncreaseStreamRetentionPeriodCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
