...
declare const StopStreamEncryptionCommand_base: {
    new (input: StopStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StopStreamEncryptionCommandInput, StopStreamEncryptionCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StopStreamEncryptionCommandInput, StopStreamEncryptionCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
