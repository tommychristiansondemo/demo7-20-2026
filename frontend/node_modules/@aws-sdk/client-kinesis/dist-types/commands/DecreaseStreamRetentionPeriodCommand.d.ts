...
declare const DecreaseStreamRetentionPeriodCommand_base: {
    new (input: DecreaseStreamRetentionPeriodCommandInput): import("@smithy/core/client").CommandImpl<DecreaseStreamRetentionPeriodCommandInput, DecreaseStreamRetentionPeriodCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DecreaseStreamRetentionPeriodCommandInput): import("@smithy/core/client").CommandImpl<DecreaseStreamRetentionPeriodCommandInput, DecreaseStreamRetentionPeriodCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
