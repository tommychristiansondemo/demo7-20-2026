...
declare const UpdateMaxRecordSizeCommand_base: {
    new (input: UpdateMaxRecordSizeCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaxRecordSizeCommandInput, UpdateMaxRecordSizeCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMaxRecordSizeCommandInput): import("@smithy/core/client").CommandImpl<UpdateMaxRecordSizeCommandInput, UpdateMaxRecordSizeCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
