...
declare const RegisterStreamConsumerCommand_base: {
    new (input: RegisterStreamConsumerCommandInput): import("@smithy/core/client").CommandImpl<RegisterStreamConsumerCommandInput, RegisterStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterStreamConsumerCommandInput): import("@smithy/core/client").CommandImpl<RegisterStreamConsumerCommandInput, RegisterStreamConsumerCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
