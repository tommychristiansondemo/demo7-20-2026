...
declare const ListStreamsCommand_base: {
    new (input: ListStreamsCommandInput): import("@smithy/core/client").CommandImpl<ListStreamsCommandInput, ListStreamsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStreamsCommandInput]): import("@smithy/core/client").CommandImpl<ListStreamsCommandInput, ListStreamsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
