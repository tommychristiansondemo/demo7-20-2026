...
declare const EnableEnhancedMonitoringCommand_base: {
    new (input: EnableEnhancedMonitoringCommandInput): import("@smithy/core/client").CommandImpl<EnableEnhancedMonitoringCommandInput, EnableEnhancedMonitoringCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableEnhancedMonitoringCommandInput): import("@smithy/core/client").CommandImpl<EnableEnhancedMonitoringCommandInput, EnableEnhancedMonitoringCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
