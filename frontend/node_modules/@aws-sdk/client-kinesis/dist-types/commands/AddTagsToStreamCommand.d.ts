...
declare const AddTagsToStreamCommand_base: {
    new (input: AddTagsToStreamCommandInput): import("@smithy/core/client").CommandImpl<AddTagsToStreamCommandInput, AddTagsToStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddTagsToStreamCommandInput): import("@smithy/core/client").CommandImpl<AddTagsToStreamCommandInput, AddTagsToStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
