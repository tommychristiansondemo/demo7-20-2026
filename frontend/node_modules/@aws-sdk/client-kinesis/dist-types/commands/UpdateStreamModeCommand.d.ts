...
declare const UpdateStreamModeCommand_base: {
    new (input: UpdateStreamModeCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamModeCommandInput, UpdateStreamModeCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStreamModeCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamModeCommandInput, UpdateStreamModeCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
