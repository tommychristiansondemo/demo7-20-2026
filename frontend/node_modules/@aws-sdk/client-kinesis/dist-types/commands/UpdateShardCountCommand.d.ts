...
declare const UpdateShardCountCommand_base: {
    new (input: UpdateShardCountCommandInput): import("@smithy/core/client").CommandImpl<UpdateShardCountCommandInput, UpdateShardCountCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateShardCountCommandInput): import("@smithy/core/client").CommandImpl<UpdateShardCountCommandInput, UpdateShardCountCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
