...
declare const ListShardsCommand_base: {
    new (input: ListShardsCommandInput): import("@smithy/core/client").CommandImpl<ListShardsCommandInput, ListShardsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListShardsCommandInput]): import("@smithy/core/client").CommandImpl<ListShardsCommandInput, ListShardsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
