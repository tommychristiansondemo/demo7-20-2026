...
declare const MergeShardsCommand_base: {
    new (input: MergeShardsCommandInput): import("@smithy/core/client").CommandImpl<MergeShardsCommandInput, MergeShardsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: MergeShardsCommandInput): import("@smithy/core/client").CommandImpl<MergeShardsCommandInput, MergeShardsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
