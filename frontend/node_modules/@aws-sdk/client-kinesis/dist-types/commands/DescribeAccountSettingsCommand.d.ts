...
declare const DescribeAccountSettingsCommand_base: {
    new (input: DescribeAccountSettingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAccountSettingsCommandInput, DescribeAccountSettingsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAccountSettingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAccountSettingsCommandInput, DescribeAccountSettingsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
