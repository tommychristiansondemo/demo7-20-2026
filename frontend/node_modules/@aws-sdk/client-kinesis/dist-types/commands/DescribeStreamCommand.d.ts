...
declare const DescribeStreamCommand_base: {
    new (input: DescribeStreamCommandInput): import("@smithy/core/client").CommandImpl<DescribeStreamCommandInput, DescribeStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStreamCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStreamCommandInput, DescribeStreamCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
