...
declare const DisableEnhancedMonitoringCommand_base: {
    new (input: DisableEnhancedMonitoringCommandInput): import("@smithy/core/client").CommandImpl<DisableEnhancedMonitoringCommandInput, DisableEnhancedMonitoringCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableEnhancedMonitoringCommandInput): import("@smithy/core/client").CommandImpl<DisableEnhancedMonitoringCommandInput, DisableEnhancedMonitoringCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
