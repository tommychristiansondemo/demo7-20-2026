...
export interface KinesisHttpAuthSchemeParameters extends HttpAuthSchemeParameters {
  region?: string;
}
export interface KinesisHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<
...
export interface KinesisHttpAuthSchemeProvider extends HttpAuthSchemeProvider<KinesisHttpAuthSchemeParameters> {}
