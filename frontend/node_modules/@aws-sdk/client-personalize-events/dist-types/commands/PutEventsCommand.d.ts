...
declare const PutEventsCommand_base: {
    new (input: PutEventsCommandInput): import("@smithy/core/client").CommandImpl<PutEventsCommandInput, PutEventsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutEventsCommandInput): import("@smithy/core/client").CommandImpl<PutEventsCommandInput, PutEventsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
