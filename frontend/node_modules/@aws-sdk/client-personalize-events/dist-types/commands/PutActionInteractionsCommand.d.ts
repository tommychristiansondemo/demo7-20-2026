...
import type { PutActionInteractionsRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const PutActionInteractionsCommand_base: {
    new (input: PutActionInteractionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionInteractionsCommandInput, PutActionInteractionsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutActionInteractionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionInteractionsCommandInput, PutActionInteractionsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
