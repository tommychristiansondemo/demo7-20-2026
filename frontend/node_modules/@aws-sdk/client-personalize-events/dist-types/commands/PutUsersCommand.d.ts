...
declare const PutUsersCommand_base: {
    new (input: PutUsersCommandInput): import("@smithy/core/client").CommandImpl<PutUsersCommandInput, PutUsersCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutUsersCommandInput): import("@smithy/core/client").CommandImpl<PutUsersCommandInput, PutUsersCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
