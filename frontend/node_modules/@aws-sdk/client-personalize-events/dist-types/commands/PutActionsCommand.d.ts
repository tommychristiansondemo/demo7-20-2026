...
declare const PutActionsCommand_base: {
    new (input: PutActionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionsCommandInput, PutActionsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutActionsCommandInput): import("@smithy/core/client").CommandImpl<PutActionsCommandInput, PutActionsCommandOutput, import("..").PersonalizeEventsClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
